...
const rotationOne = getRotationChars(['Gecko Moria', 'Nico Robin', 'Dalmatian']);
const rotationTwo = getRotationChars(['Usopp', 'Capone Gang Bege', 'Hina']);
