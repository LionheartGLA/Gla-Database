...
const rotationOne = getRotationChars(['Leo e Mansherry', 'Koala', 'Jewelry Bonney']);
const rotationTwo = getRotationChars(['Uta', 'Capone Gang Bege', 'Perona']);
