...
const rotationOne = getRotationChars(['Urouge', 'Vinsmoke Sanji', 'Smoker']);
const rotationTwo = getRotationChars(['Roronoa Zoro', 'Vinsmoke Ichiji', 'Bellamy']);
